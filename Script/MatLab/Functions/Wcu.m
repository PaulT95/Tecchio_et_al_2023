function [cu_corrected, order_corrected]=Wcu(order_input, cu, filtertype, Fs)

% *Calculate correct cut-off frequency for n-pass Butterworth filter*
%Wcu(desired filter order following n-passes, desired cut-off frequency, type[low, high, stop, bandpass], fps)
